...
v = zeros(k,1);% n value for adagrad
for ii = 1:rd
    
    [Weight,v] = learn_sharpe_version_momentum(Weight,var_covar_matrix,rate,cumulative_return,v);
...
round = 1:point;
a = get(0,'ScreenSize') ;
Map = figure('Name','momentum','position',[a(3)/2-300,a(4)/2-150,600,300],'menubar','none','NumberTitle','off') ;
