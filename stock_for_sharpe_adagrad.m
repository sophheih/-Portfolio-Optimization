...
n = zeros(k,1);% n value for adagrad
for ii = 1:rd
    
    [Weight,n] = learn_sharpe_version_adagrad(Weight,var_covar_matrix,rate,cumulative_return,n);
...
round = 1:rd;
a = get(0,'ScreenSize') ;
Map = figure('Name','AdaGrad','position',[a(3)/2-300,a(4)/2-150,600,300],'menubar','none','NumberTitle','off') ;
